...
const CONFORMANCE_AREAS: readonly AreaEvidence[] = Object.freeze([
  ...
  area(10, 'nearest seek landing and callback-order determinism',
    ['./engine-web-demuxer-evidence.test.ts', 'selects the nearest real PTS with an earlier tie, falls forward before zero'],
